...
const sheetOverlay = bottomSheet.querySelector(".sheet_overlay");
const sheetContent = bottomSheet.querySelector(".content");
const dragIcon = bottomSheet.querySelector(".drag_icon");
...
dragIcon.addEventListener("mousedown", draggingStart);
document.addEventListener("mousemove", dragging);

document.addEventListener("touchend", draggingStop);
dragIcon.addEventListener("touchstart", draggingStart);
